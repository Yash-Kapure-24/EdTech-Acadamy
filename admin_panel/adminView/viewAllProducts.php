  ...
  <table class="table ">
    <thead>
      <tr>
        ...
        <th class="text-center">Courses Image</th>
        <th class="text-center">Courses Name</th>
        <th class="text-center">Courses Description</th>
      ...
      <!-- <div class="modal-content">
        ...
        <div class="modal-body">
          <form  enctype='multipart/form-data' onsubmit="addItems()" method="POST">
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-secondary" id="upload" style="height:40px">Add Course</button>
            </div>
          </form>
